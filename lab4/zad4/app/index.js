...
// 1. Modified Flip Card: Generalized flip component
const FlipCard = ({
  isFlipped,
  cardStyle,
  direction = 'y',
...
const FlipCardExample = () => {
  ...
  return (
    <View style={styles.exampleContainer}>
      <Text style={styles.title}>1. Flip Card (Generalized)</Text>
      <TouchableOpacity 
        ...
        <FlipCard
          ...
          RegularContent={
            <View style={[styles.card, styles.cardFront]}>
              <Text style={styles.cardText}>PRZÓD</Text>
            </View>
          }
          FlippedContent={
            <View style={[styles.card, styles.cardBack]}>
              <Text style={styles.cardText}>TYŁ</Text>
            </View>
          }
        />
      </TouchableOpacity>
